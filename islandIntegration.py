...
def submit_run(gene_id):
    def write_bash_script_py(gene_id, train_file='./sota/ExquisiteNetV2/train.py'):
        ...
        bash_script_content = PYTHON_BASH_SCRIPT_TEMPLATE.format(LLM_GPU, CONDA_ENV, python_runline)
        return bash_script_content
...
if __name__ == "__main__":
    ...
    # Evolution
    for gen in range(start_gen, start_gen + (migration_gen - 1) % num_generations + 1):
        GEN_COUNT = gen
